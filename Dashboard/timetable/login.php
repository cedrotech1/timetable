      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="demo-accounts">
            ...
            <hr>
            <div class="demo-account mb-3">
              <h6><i class="bi bi-person"></i> huye dean office Account</h6>
              <p class="mb-1"><strong>Email:</strong>dean@gmail.com</p>
                <p class="mb-1"><strong>Password:</strong> 1234</p>
                <button class="btn btn-sm btn-primary use-demo" data-email="dean@gmail.com" data-pass="1234">Use This Account</button>
            </div>

            <hr>
            <div class="demo-account mb-3">
              <h6><i class="bi bi-person"></i> Huye registrar office Account</h6>
              <p class="mb-1"><strong>Email:</strong>registrar@gmail.com</p>
                <p class="mb-1"><strong>Password:</strong> 1234</p>
                <button class="btn btn-sm btn-primary use-demo" data-email="registrar@gmail.com" data-pass="1234">Use This Account</button>
            </div> 

            <hr>
            <div class="demo-account mb-3">
              <h6><i class="bi bi-person"></i> Huye dtle Account</h6>
              <p class="mb-1"><strong>Email:</strong>dtle@gmail.com</p>
                <p class="mb-1"><strong>Password:</strong> 1234</p>
                <button class="btn btn-sm btn-primary use-demo" data-email="dtle@gmail.com" data-pass="1234">Use This Account</button>
            </div>

            <hr>
            <div class="demo-account mb-3">
              <h6><i class="bi bi-person"></i> lecturer Account</h6>
              <p class="mb-1"><strong>Email:</strong>bugingo  @gmail.com</p>
                <p class="mb-1"><strong>Password:</strong> 1234</p>
                <button class="btn btn-sm btn-primary use-demo" data-email="bugingo@gmail.com" data-pass="1234">Use This Account</button>
            </div>
