  ...
  <div class="container">
    <div class="card page-title">
      <h2 class="text-light mb-0">
        Schedule Timetable for academic year: <?php echo htmlspecialchars($academic_year_label ?: '-'); ?>, Semester <?php echo htmlspecialchars($semester ?: '-');  ?> for school <?php echo htmlspecialchars($school_name ?: '-'); ?>
      </h2>
    </div>
