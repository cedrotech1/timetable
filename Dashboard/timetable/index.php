...
$(document).ready(function() {
    ...
    function renderTreeView() {
        ...
        organizationData.forEach(campus => {
            treeView.append(createTreeItem('campus', campus));
        });
    }
    ...
    function createTreeItem(type, item) {
        ...
        switch (type) {
            case 'campus':
                hasChildren = item.colleges && item.colleges.length > 0;
                childCount = hasChildren ? item.colleges.length : 0;
                break;
        ...
        if (hasChildren) {
            ...
            switch (type) {
                case 'campus':
                    if (item.colleges) {
                        item.colleges.forEach(c => $children.append(createTreeItem('college', c)));
                    }
                    break;
