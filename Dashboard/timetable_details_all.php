...
let currentFacilityPickForTimetable = null; // which timetable is picking
...
async function openFacilityPicker(forTimetableId) {
    ...
    const modal = new bootstrap.Modal(document.getElementById('facilityPickerModal'));
    modal.show();
}
...
function pickFacility(facilityId, facilityName) {
    ...
    // close modal
    const modalEl = document.getElementById('facilityPickerModal');
        ...
        <div class="col-md-12"></div>
            <div class="col-md-6">
                <div class="card">
                  ...
                  <strong>  Module:  </strong>${data.course}<br>
                    <p><strong>Credits:</strong> ${data.credits} <br>
                 <strong>Module code:</strong> ${data.code}</p>          
            </div>
        </div>
    </div>
</div>
                ...
                <hr>
                     <p class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <button class="btn btn-primary btn-sm" onclick="changeFacility(${data.id})">Update</button>
                         <button class="btn btn-success btn-sm" onclick="approveTimetable(${data.id})">Approve</button>
                        <?php } ?>
                    </p>
        </div>
    </div>
