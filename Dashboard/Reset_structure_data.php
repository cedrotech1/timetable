...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        if (password_verify($password, $hashedPassword)) {
            ...
            $truncate = "TRUNCATE TABLE campus";
            mysqli_query($connection, $truncate);

            $truncate = "TRUNCATE TABLE college";
            mysqli_query($connection, $truncate);

            $truncate = "TRUNCATE TABLE school";
            mysqli_query($connection, $truncate);

            $truncate = "TRUNCATE TABLE department";
            mysqli_query($connection, $truncate);

            $truncate = "TRUNCATE TABLE program";
            mysqli_query($connection, $truncate);

            $truncate = "TRUNCATE TABLE intake";
            mysqli_query($connection, $truncate);
